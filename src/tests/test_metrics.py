...
def test_internal_metrics(dns_exporter_example_config, tmp_path, caplog):
    ...
    for metric in [
        ...
        'dnsexp_http_requests_total{path="/query"} 96.0',
        ...
        'dnsexp_http_responses_total{path="/query",response_code="200"} 96.0',
        'dnsexp_http_responses_total{path="/",response_code="200"} 1.0',
        "dnsexp_dns_queries_total 79.0",
        ...
        'dnsexp_scrape_failures_total{additional="none",answer="none",authority="none",family="none",flags="none",ip="none",nsid="none",opcode="none",port="none",protocol="none",proxy="none",query_name="none",query_type="none",rcode="none",reason="invalid_request_proxy",server="none",transport="none"} 2.0',
    ]:
